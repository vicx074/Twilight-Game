...
var text_width = string_width("Use E para desintegrar") + 10; // Largura do texto com uma margem
var text_height = string_height("Use E para desintegrar") + 10; // Altura do texto com uma margem
...
draw_set_color(c_black);
draw_text(x, y, "Use E para desintegrar");
